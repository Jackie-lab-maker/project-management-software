  ...
  project: {
    ...
    files: {
      ...
      folders: {
        ...
        fundingSlides: "Funding Slides",
        reviewSlides: "Project Review Slides",
        vendorProposal: "Vendor Proposal",
        vendorQuotation: "Vendor Quotation",
        biddingDocument: "Bidding Document",
        ktda: "KTDA",
        softwareHardwareRequirement: "Software/Hardware Requirement",
        sowDoc2: "SOW & DOC2",
        hardwareDesign: "Hardware Designing",
        softwareDesign: "Software Designing",
        otherDocuments: "Other Documents",
        vendorSchedule: "Vendor Schedule",
        internalSchedule: "Internal Schedule",
        facDocuments: "FAC Documents",
        batch1: "1st Batch",
        batch2: "2nd Batch",
        batch3: "3rd Batch",
        facilityItRequirement: "Facility & IT Requirement",
        installationDocument: "Installation Document",
        sac: "SAC",
        uat: "UAT",
        ehsQaOtherAcceptance: "EHS & QA & Other Acceptance",
        gcpChange: "GCP Change",
        pilotRun: "Pilot Run",
        performanceTrack: "Performance Track",
        vendorOperationManual: "Vendor Operation Manual",
        buyoffDocumentWithVendor: "Buyoff Document With Vendor",
        benefitBuyoff: "Benefit Buyoff",
  ...
  project: {
    ...
    files: {
      ...
      folders: {
        ...
        fundingSlides: "经费幻灯片",
        reviewSlides: "项目评审幻灯片",
        vendorProposal: "供应商方案书",
        vendorQuotation: "供应商报价单",
        biddingDocument: "招标文件",
        ktda: "KTDA",
        softwareHardwareRequirement: "软件/硬件需求",
        sowDoc2: "SOW 与 DOC2",
        hardwareDesign: "硬件设计",
        softwareDesign: "软件设计",
        otherDocuments: "其他文档",
        vendorSchedule: "供应商进度计划",
        internalSchedule: "内部进度计划",
        facDocuments: "FAC 文件",
        batch1: "第一批",
        batch2: "第二批",
        batch3: "第三批",
        facilityItRequirement: "设施与信息化需求",
        installationDocument: "安装文件",
        sac: "SAC",
        uat: "UAT",
        ehsQaOtherAcceptance: "EHS、QA 及其他验收",
        gcpChange: "GCP 变更",
        pilotRun: "试运行",
        performanceTrack: "性能追踪",
        vendorOperationManual: "供应商操作手册",
        buyoffDocumentWithVendor: "与供应商的验收文件",
        benefitBuyoff: "效益验收",
        sparePartsList: "备件清单",
